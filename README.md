...
[![Latest release](https://img.shields.io/github/v/release/dd3ok/tossinvest-api-skill?sort=semver)](https://github.com/dd3ok/tossinvest-api-skill/releases/latest)

> 30초 요약: 비공식 토스증권 API / TossInvest API를 다루는 Agent Skill입니다.
...
Agent skill로 설치하지 않고 Python 스크립트만 실행할 수도 있습니다. 번들 스크립트는 Python 표준 라이브러리만 사용하며, 네트워크 접근이 필요합니다.
...
Maintainer와 CI 검증에는 다음 명령을 사용합니다.
