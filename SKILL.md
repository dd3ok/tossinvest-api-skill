...
| Recommended feed, news discovery, and sanitized public community rankings | `scripts/feed.py` | [Feed and news APIs](references/api-catalog.md#feed-and-news-apis) |
| Sanitized public stock/lounge community comments and replies | `scripts/community_comments.py` | [Public community shapes](references/response-notes.md#public-community-shapes) |
...
| Page-level stock API smoke checks | `scripts/page_api_check.py` | [Page API smoke checks](references/script-cookbook.md#page-api-smoke-checks) |
